package ru.itis.persikill.androidhomeworks.notification
...
import ru.itis.persikill.androidhomeworks.MainActivity
import ru.itis.persikill.androidhomeworks.service.MusicPlayerService
...
class PlayerNotificationManager(
    ...
    fun createNotification(itemId: Int, player: MediaPlayer) {
        val track = MusicRepository.findMusicById(itemId)
        ...
        track?.let {
            ...
            val notification = NotificationCompat.Builder(context, context.getString(R.string.channel_id))
                ...
                .addAction(R.drawable.back, context.getString(R.string.previous), previousPendingIntent)
                .addAction(R.drawable.pause, context.getString(R.string.resume), resumePendingIntent)
